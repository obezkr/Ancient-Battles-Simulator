#v.003
# автоматизировано ведение боя, классы юнитов теперь более стабилизированы, исправлен дизайн игры
import pygame
import math
...
while True:
    ...
    f5 = pygame.font.Font(None, 24)
    text5 = f5.render(str(goldB), 0, GOLD)
    
    f6 = pygame.font.Font(None, 24)
    text6 = f6.render(str(goldR), 0, GOLD)
