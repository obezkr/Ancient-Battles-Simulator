...
for i in range(len(l)):
    if l[i]!='o':
        for x in range(len(l[i])):
            if l[i][x]=="[" or l[i][x]=="]" or l[i][x]=="'" or l[i][x]=="," or l[i][x]=="\n" or l[i][x]==".":
                l[i][x]='-'
for i in range(len(l)):
    if l[i]!='o':
        x=0
...
i=0
while i<len(RW):
    pygame.draw.rect(sc, (RED), (RW[i]-razmer/2, RW[i+1]-razmer/2, razmer, razmer))
    i=i+2
RWMove=[]
i=0
while i<len(RA):
    pygame.draw.rect(sc, (REDA), (RA[i]-razmer/2, RA[i+1]-razmer/2, razmer, razmer))
    i=i+2
RAMove=[]
i=0
while i<len(RSH):
    pygame.draw.rect(sc, (REDSH), (RSH[i]-razmer/2, RSH[i+1]-razmer/2, razmer, razmer))
    i=i+2
RSHMove=[]
i=0
while i<len(RP):
    pygame.draw.rect(sc, (REDP), (RP[i]-razmer/2, RP[i+1]-razmer/2, razmer, razmer))
    i=i+2
RPMove=[]
i=0
while i<len(RC):
    pygame.draw.rect(sc, (REDC), (RC[i]-razmerC/2, RC[i+1]-razmerC/2, razmerC, razmerC))
    i=i+2
RCMove=[]
