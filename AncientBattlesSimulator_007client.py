...
mpic = mainpic.get_rect(bottomleft=(-250, 400))
sc.blit(mainpic, mpic)
pygame.draw.line(sc, WHITE, [0, 250], [300, 250], 2)
pygame.draw.line(sc, WHITE, [0, 200], [150, 200], 2)
pygame.draw.line(sc, WHITE, [0, 150], [150, 150], 2)
pygame.draw.line(sc, WHITE, [0, 100], [150, 100], 2)
pygame.draw.line(sc, WHITE, [0, 100], [0, 300], 2)
pygame.draw.line(sc, WHITE, [50, 100], [50, 300], 2)
pygame.draw.line(sc, WHITE, [100, 100], [100, 300], 2)
pygame.draw.line(sc, WHITE, [150, 100], [150, 300], 2)
f1 = pygame.font.Font(None, 32)
text1 = f1.render('1', 1, (WHITE))
text2 = f1.render('2', 1, (WHITE))
text3 = f1.render('3', 1, (WHITE))
text4 = f1.render('4', 1, (WHITE))
text5 = f1.render('5', 1, (WHITE))
text6 = f1.render('6', 1, (WHITE))
text7 = f1.render('7', 1, (WHITE))
text8 = f1.render('8', 1, (WHITE))
text9 = f1.render('9', 1, (WHITE))
text0 = f1.render('0', 1, (WHITE))
text10 = f1.render('.', 1, (WHITE))
text11 = f1.render('Connect', 1, (WHITE))
sc.blit(text1, (25, 125))
sc.blit(text2, (75, 125))
sc.blit(text3, (125, 125))
sc.blit(text4, (25, 175))
sc.blit(text5, (75, 175))
sc.blit(text6, (125, 175))
sc.blit(text7, (25, 225))
sc.blit(text8, (75, 225))
sc.blit(text9, (125, 225))
sc.blit(text0, (75, 275))
sc.blit(text10, (125, 275))
sc.blit(text11, (180, 265))
pygame.display.update()
while True:
    clock.tick(FPS)
    text12 = f1.render(''.join(adr), 0, (WHITE))
    sc.blit(text12, (80, 50))
    for i in pygame.event.get():
        ...
        if i.type == pygame.MOUSEBUTTONDOWN:
            ...
            if 0<x<50 and 150<y<200:
                adr.append('4')
            if 50<x<100 and 150<y<200:
                adr.append('5')
            if 100<x<150 and 150<y<200:
                adr.append('6')
            if 0<x<50 and 200<y<250:
                adr.append('7')
            if 50<x<100 and 200<y<250:
                adr.append('8')
            if 100<x<150 and 200<y<250:
                adr.append('9')
            if 50<x<100 and 250<y<300:
                adr.append('0')
            if 100<x<150 and 250<y<300:
                adr.append('.')
            if 150<x<300 and 250<y<300:
                pygame.quit()
                pp=1
    if pp==1:
        break
...
sound3=pygame.mixer.Sound('music\ForLooser.ogg')
sound4=pygame.mixer.Sound('music\screams in battle.ogg')
sound5=pygame.mixer.Sound('music\ForWinner.ogg')
    ...
    for i in pygame.event.get():
        ...
        if i.type == pygame.KEYUP:
            ...
            if i.key == pygame.K_r:
                ...
                BW = data.decode("utf-8")
                BW=BW.replace('[', '')
                BW=BW.replace(']', '')
                BW=BW.split(', ')
                if len(BW)>1:
                    for i1 in range(0, len(BW), 2):
                        BW[i1]=float(BW[i1])
                        BW[i1+1]=float(BW[i1+1])
                        BWHP.append(WHP)
                ...
                BA=BA.split(', ')
                if len(BA)>1:
                    for i1 in range(0, len(BA), 2):
                        BA[i1]=float(BA[i1])
                        BA[i1+1]=float(BA[i1+1])
                        BAHP.append(AHP)
                ...
                ##1111
                data = conn.recv(1024*256)
                BSH = data.decode("utf-8")
                BSH=BSH.replace('[', '')
                BSH=BSH.replace(']', '')
                BSH=BSH.split(', ')
                if len(BSH)>1:
                    for i1 in range(0, len(BSH), 2):
                        BSH[i1]=float(BSH[i1])
                        BSH[i1+1]=float(BSH[i1+1])
                        BSHHP.append(SHHP)
                ...
                ##1111
                data = conn.recv(1024*256)
                BP = data.decode("utf-8")
                BP=BP.replace('[', '')
                BP=BP.replace(']', '')
                BP=BP.split(', ')
                if len(BP)>1:
                    for i1 in range(0, len(BP), 2):
                        BP[i1]=float(BP[i1])
                        BP[i1+1]=float(BP[i1+1])
                        BPHP.append(PHP)
                ...
                ##1111
                data = conn.recv(1024*256)
                BC = data.decode("utf-8")
                BC=BC.replace('[', '')
                BC=BC.replace(']', '')
                BC=BC.split(', ')
                if len(BC)>1:
                    for i1 in range(0, len(BC), 2):
                        BC[i1]=float(BC[i1])
                        BC[i1+1]=float(BC[i1+1])
                        BCHP.append(CHP)
